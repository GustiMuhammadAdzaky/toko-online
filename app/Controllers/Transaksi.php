...
class Transaksi extends BaseController
{
    ...
    public function invoice()
    {
        ...
        $pdf->SetAuthor('Resvi Maulidania');
        ...
        $this->sendEmail($attachment, $transaksi->email, 'Invoice', $message);
    ...
    {
        $this->email->setFrom('kolepitbio@gmail.com', 'Kolep Itbio');
        $this->email->setTo($to);
    ...
    public function delate()
    {
        ...
        $transaksiModel = new \App\Models\TransaksiModel();
        $delete = $transaksiModel->delete($id);
